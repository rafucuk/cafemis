# Contribution guide
We're glad you're interested in contributing to Cafemis! In this document you will find the information you need to contribute to the project.
...
5. Create a [release](https://github.com/rafucuk/cafemis/-/releases)
...
Cafemis has its own Icon Font called Shark Font which can be found at https://activitypub.software/TransFem-org/shark-font
...
When Updating the Font make sure to copy **all generated files** from the `dest` folder into `packages/backend/assets/fonts/cafemis-icons`
...
Cafemis uses GitLab CI for executing automated tests.
