...
- Enhance: 過去に送信したフォローリクエストを確認できるように  
  (Based on https://github.com/rafucuk/cafemis/-/merge_requests/663)
...
- Fix: TypeScriptの型チェック対象ファイルを限定してビルドを高速化するように  
	(Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/725)

### Server
- Enhance: DockerのNode.jsを22.11.0に更新
- Enhance: 起動前の疎通チェックで、DBとメイン以外のRedisの疎通確認も行うように  
  (Based on https://github.com/rafucuk/cafemis/-/merge_requests/588)  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/715)
...
- Fix: 招待コードの発行可能な残り数算出に使用すべきロールポリシーの値が違う問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/706)
- Fix: 連合への配信時に、acctの大小文字が区別されてしまい正しくメンションが処理されないことがある問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/711)
- Fix: ローカルユーザーへのメンションを含むノートが連合される際に正しいURLに変換されないことがある問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/712)
- Fix: FTT無効時にユーザーリストタイムラインが使用できない問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/709)
- Fix: User Webhookテスト機能のMock Payloadを修正  
- Fix: アカウント削除のモデレーションログが動作していないのを修正 (#14996)  
- Fix: リノートミュートが新規投稿通知に対して作用していなかった問題を修正
- Fix: Inboxの処理で生じるエラーを誤ってActivityとして処理することがある問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/730)
- Fix: セキュリティに関する修正
...
- Fix: キューのエラーログを簡略化するように  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/649)
...
- Fix: クライアント上での時間ベースの実績獲得動作が実績獲得後も発動していた問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/657)
...
- Fix: ファイルの詳細ページのファイルの説明で改行が正しく表示されない問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/commit/bde6bb0bd2e8b0d027e724d2acdb8ae0585a8110)
...
- Fix: 外部ページを解析する際に、ページに紐づけられた関連リソースも読み込まれてしまう問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/commit/26e0412fbb91447c37e8fb06ffb0487346063bb8)
- Fix: Continue importing from file if single emoji import fails
- Fix: `Retry-After`ヘッダーが送信されなかった問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/commit/8a982c61c01909e7540ff1be9f019df07c3f0624)
- Fix: サーバーサイドのDOM解析完了時にリソースを開放するように  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/634)
- Fix: `<link rel="alternate">`を追って照会するのはOKレスポンスが返却された場合のみに  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/633)
...
- Fix: サーバー情報取得の際にモデレーター限定の情報が取得できないことがあるのを修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/582)
...
- Fix: 「アニメーション画像を再生しない」がオンのときでもサーバーのバナー画像・背景画像がアニメーションしてしまう問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/574)
...
- Fix: WebGL2をサポートしないブラウザで「季節に応じた画面の演出」が有効になっているとき、Misskeyが起動できなくなる問題を修正  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/459)
...
- Fix: フォローリクエストを作成する際に既存のものは削除するように  
  (Cherry-picked from https://github.com/rafucuk/cafemis/-/merge_requests/440)
