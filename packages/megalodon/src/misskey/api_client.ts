  ...
  export namespace Converter {
    ...
    export const user = (u: Entity.User, host: string | null = null): MegalodonEntity.Account => {
      ...
      return {
        ...
        url: u.uri ?? acctUrl,
        avatar: u.avatarUrl ? u.avatarUrl : 'https://dev.cafemis.com/static-assets/avatar.png',
        avatar_static: u.avatarUrl ? u.avatarUrl : 'https://dev.cafemis.com/static-assets/avatar.png',
        header: u.bannerUrl ? u.bannerUrl : 'https://dev.cafemis.com/static-assets/transparent.png',
        header_static: u.bannerUrl ? u.bannerUrl : 'https://dev.cafemis.com/static-assets/transparent.png',
