...
const extension_context_definition = {
	...
	// Cafemis
	cafemis: 'https://cafemis.com/ns#',
	hideOnlineStatus: 'cafemis:hideOnlineStatus',
	backgroundUrl: 'cafemis:backgroundUrl',
	listenbrainz: 'cafemis:listenbrainz',
	enableRss: 'cafemis:enableRss',
	// vcard
	vcard: 'http://www.w3.org/2006/vcard/ns#',
} satisfies Context;
