...
const themeColor = chalk.hex('#f5a9e0');
...
function greet() {
	if (!envOption.quiet) {
		...
		console.log(' Cafemis is an open-source decentralized microblogging platform.');
		console.log(chalk.rgb(255, 136, 0)(' If you like Cafemis, please donate to support development. https://opencollective.com/cafemis'));

		console.log('');
		console.log(chalkTemplate`--- ${os.hostname()} {gray (PID: ${process.pid.toString()})} ---`);
	}

	bootLogger.info('Welcome to Cafemis!');
	bootLogger.info(`Cafemis v${meta.version}`, null, true);
}
...
export async function masterMain() {
	...
	bootLogger.succ('Cafemis initialized');
