...
export async function getInstance(
	...
	return {
		uri: config.url,
		title: meta.name || 'Cafemis',
		short_description:
			meta.description || 'This is a vanilla Cafemis Instance. It doesn\'t seem to have a description.',
		description:
			meta.description ||
			'This is a vanilla Cafemis Instance. It doesn\'t seem to have a description.',
		email: response.email || '',
		version: `3.0.0 (compatible; Cafemis ${config.version})`,
		urls: response.urls,
		stats: {
