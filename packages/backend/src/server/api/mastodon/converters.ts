...
export class MastoConverters {
	...
	public async convertAccount(account: Entity.Account | MiUser) {
		...
		return awaitAll({
			...
			avatar: user.avatarUrl ? user.avatarUrl : 'https://dev.cafemis.com/static-assets/avatar.png',
			avatar_static: user.avatarUrl ? user.avatarUrl : 'https://dev.cafemis.com/static-assets/avatar.png',
			header: user.bannerUrl ? user.bannerUrl : 'https://dev.cafemis.com/static-assets/transparent.png',
			header_static: user.bannerUrl ? user.bannerUrl : 'https://dev.cafemis.com/static-assets/transparent.png',
			emojis: emoji,
			moved: null, //FIXME
