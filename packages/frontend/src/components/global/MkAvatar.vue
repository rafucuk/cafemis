...
.root {
	...
	flex-shrink: 0;
	border-radius: 100%; // cafemis: controlled by square avatars setting!
	line-height: 16px;
	z-index: 0; // cafemis: starts stacking context to help with showing decorations behind the avatar
}
...
.square {
	border-radius: 20%; // cafemis: controlled by square avatars setting!
