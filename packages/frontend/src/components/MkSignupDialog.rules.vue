	...
	<MkSpacer :marginMin="20" :marginMax="28">
		<div class="_gaps_m">
			...
			<MkFolder :defaultOpen="true">
				...
				<a href="https://github.com/rafucuk/cafemis/-/blob/stable/IMPORTANT_NOTES.md" class="_link" target="_blank">{{ i18n.ts.basicNotesBeforeCreateAccount }} <i class="ti ti-external-link"></i></a>
