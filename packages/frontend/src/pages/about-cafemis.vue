		...
		<MkSpacer :contentMax="600" :marginMin="20">
			<div class="_gaps_m znqjceqz">
				...
				<div style="text-align: center;">
					{{ i18n.ts._aboutMisskey.about }}<br><a href="https://cafemis.com/" target="_blank" class="_link">{{ i18n.ts.learnMore }}</a>
				</div>
				<div v-if="$i != null" style="text-align: center;">
					<MkButton primary rounded inline @click="iLoveMisskey">I <Mfm text="$[jelly ❤]"/> #Cafemis</MkButton>
				</div>
				<FormSection v-if="instance.repositoryUrl !== 'https://github.com/rafucuk/cafemis/'">
					<div class="_gaps_s">
						<MkInfo>
						...
						<FormLink v-if="instance.providesTarball" :to="`/tarball/cafemis-${version}.tar.gz`" external>
				...
				<FormSection>
					<div class="_gaps_s">
						<FormLink to="https://github.com/rafucuk/cafemis/" external>
...
const everyone = ref<Section[]>([
	{
		...
		link: {
			...
			url: 'https://github.com/rafucuk/cafemis/-/graphs/develop',
		},
		people: fisher_yates([
			{
				handle: '@rafucuk',
				avatar: 'https://avatars.githubusercontent.com/u/33981808?v=4',
				link: 'https://github.com/rafucuk',
			},
		]),
	},
	{
